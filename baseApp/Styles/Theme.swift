...
//        application.keyWindow?.tintColor = tint
        ...
        UITabBar.appearance().with {
            $0.barStyle = barStyle
            $0.backgroundColor = backgroundButtonColor
            $0.barTintColor = backgroundButtonColor
//            $0.tintColor = tint
        }
//
...
//        ViewTop.appearance().backgroundColor = header
//        ViewReportarOferta.appearance().backgroundColor = backgroundColor
//        ViewBottom.appearance().backgroundColor = backgroundColor
//        ViewTitleBackground.appearance().backgroundColor = titleBackground
//
//        AppLabel.appearance().backgroundColor = titleBackground
//        UILabelPadding.appearance().backgroundColor = titleBackground
